...
var app = express();
mongoose.connect('mongodb://localhost/ajax-todo'); //db not created until 1st save
...
app.post('/priorities', priorities.create); //send you to priorities object, create method
